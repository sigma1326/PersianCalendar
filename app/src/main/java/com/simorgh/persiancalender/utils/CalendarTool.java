package com.simorgh.persiancalender.utils;
...
public class CalendarTool {
    ...
    public String getIranianFormalDate() {
        return getIranianDay() + " " + getIranianMonthName() + " " + getIranianYear();
    }

    public static String getIranianFormalDate(CalendarTool ct) {
        return ct.getIranianDay() + " " + ct.getIranianMonthName() + " " + ct.getIranianYear();
    }

    public String getGregorianFormalDate() {
        return getGregorianDay() + " " + getGregorianMonthName() + " " + getGregorianYear();
    }

    public String getArabicFormalDate() {
        return getJulianDay() + " " + getArabicMonthName() + " " + getJulianYear();
    }


    public static String getGregorianFormalDate(CalendarTool ct) {
        return ct.getGregorianDay() + " " + ct.getGregorianMonthName() + " " + ct.getGregorianYear();
    }
    ...
    public void rollUpMonth() {
        ...
        setIranianDate(irYear, irMonth, 1);
    }
